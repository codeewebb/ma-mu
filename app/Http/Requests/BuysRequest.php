   ...
   public function rules()
    {
        ...
        'final_price'      => 'required|max:500000|numeric',
        // // required|numeric
        ];
    }
       ...
       public function messages()
    {
        ...
        // 'final_price.max'             => '   الاسم يجب ان يكون اقل من 30 حرف ',
        // 'final_price.numeric'             => '  الحقل يجب ان يكون ارقام ',
        // 'final_price.required'          => 'هذا الاسم موجود بالفعل !!'
